...
public class CategoryTestCase {
	...
	//
	// assertEquals("Successfully added this category inside the
	...
	//
	// assertEquals("Successfully fetched a single category inside the
	// table!",true,category.get(category));
	//
	// }
